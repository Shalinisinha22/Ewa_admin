...
const storeAccess = (req, res, next) => {
  ...
  // Add storeId to request for use in controllers
  req.storeId = req.admin.storeId;
  
  // For super admins, allow access to all stores if storeId is provided in query
  if (req.admin.role === 'super_admin' && req.query.storeId) {
