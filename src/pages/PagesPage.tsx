  ...
  useEffect(() => {
    const mockPages: Page[] = [
      ...
      },
      {
        ...
        title: 'Contact Us',
        slug: 'contact-us',
        content: '<h1>Contact EWA Fashion</h1><p>Get in touch with us...</p>',
        metaDescription: 'Contact EWA Fashion for any queries or support.',
        isPublished: true,
        createdAt: '2024-01-01',
      ...
      },
      {
        ...
        title: 'Refund Policy',
        slug: 'refund-policy',
        content: '<h1>Refund Policy</h1><p>Our refund policy details...</p>',
        metaDescription: 'EWA Fashion refund and return policy.',
        isPublished: true,
        createdAt: '2024-01-10',
        updatedAt: '2024-01-10',
      },
      {
        ...
        slug: 'shipping-info',
        content: '<h1>Shipping Information</h1><p>Learn about our shipping options...</p>',
        metaDescription: 'EWA Fashion shipping information and delivery details.',
        isPublished: true,
        createdAt: '2024-01-10',
        updatedAt: '2024-01-10',
      },
